...
echo "🚀 [AAPT V1 BUILDER] Constructing Matrix CE APK..."
...
echo "  -> Packaging Resources (aapt)..."
aapt package -f -M $BUILD_DIR/AndroidManifest.xml -S $BUILD_DIR/res -I $ANDROID_JAR -F $BUILD_DIR/bin/MatrixCE.unsigned.apk -m -J $BUILD_DIR/src
...
javac -d $BUILD_DIR/obj \
    ...
    $BUILD_DIR/src/com/matrix/ce/MainActivity.java $BUILD_DIR/src/com/matrix/ce/R.java
